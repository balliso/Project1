...
all_cat_vars<-intersect(all_cat_vars, names(census))
...
Now, we will investigate if there appears to be a relationship between household internet access and age in North Carolina in 2022. Are young people more likely to have household internet access?
